...
public class SputumResults implements java.io.Serializable
{
	...
	public SputumResults(int sputumTestId, String patientId, int month)
	{
	...
	public SputumResults(int sputumTestId, String patientId, String laboratoryId, int irs, int month, Date dateSubmitted, Date dateTested,
