...
public class DateTimeUtil {
	...
	public static int calculateMonthOfTreatment(String treatmentStartDate) {
		...
		try {
			txStart = getDateFromString(treatmentStartDate, BE_FORMAT);
		}
		...
		GregorianCalendar gcTx = (GregorianCalendar) GregorianCalendar.getInstance();
		...
		54  - 83 days = Month 2
		84  - 113 days = Month 3
		114 - 143 days = Month 4
		144 -  173 days = Month 5
		174 -  203 days = Month 6
		204 -  233 days = Month 7
		234 -  263 days = Month 8 
		    264-  293 days = Month 9
		    294-  323 days = Month 10 */
