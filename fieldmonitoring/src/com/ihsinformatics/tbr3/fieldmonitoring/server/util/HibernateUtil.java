...
package com.ihsinformatics.tbr3.fieldmonitoring.server.util;
...
import com.ihsinformatics.tbr3.fieldmonitoring.server.LogType;
import com.ihsinformatics.tbr3.fieldmonitoring.shared.FM;
import com.ihsinformatics.tbr3.fieldmonitoring.shared.model.LogData;
import com.ihsinformatics.tbr3.fieldmonitoring.shared.model.LogLogin;
...
public class HibernateUtil implements Serializable
{
	...
	public void recordLog (LogType logType, Object obj)
	{
		...
		switch (logType)
		{
			...
			case INSERT :
			case UPDATE :
				logObj = new LogData (FM.getCurrentUserName (), logType.toString (), new Date (), className, (objClass).cast (obj).toString ());
				break;
			case LOGIN :
				logObj = new LogLogin (FM.getCurrentUserName (), new Date (), null, "");
				break;
		}
		try
		{
