...
//					list.add (record.substring (0, record.length () - 1));
//			}
//			String dest = FM.getResourcesPath () + String.valueOf (new Date ().getTime ()) + ".csv";
...
//
//			JasperReport jasperReport = JasperCompileManager.compileReport (FM.getReportPath () + fileName
//					+ (fileName.endsWith (".jrxml") ? "" : ".jrxml"));
//			JasperPrint print = JasperFillManager.fillReport (jasperReport, new HashMap (), resultSource);
//			String dest = FM.getResourcesPath () + String.valueOf (new Date ().getTime ())
//					+ (export == true ? ".csv" : ".pdf");
//			// Delete file if existing
//			try
//			{
...
//		{
//			Connection con = HibernateUtil.util.getSession ().connection ();
//			con.setCatalog (FM.getDatabaseName ());
...
//			}
//			String filePath = FM.getReportPath () + fileName + (fileName.endsWith (".jrxml") ? "" : ".jrxml");
...
//	{
//		String[][] reports;
//		File dir = new File (FM.getReportPath ());
