...
insert into openmrs.concept select * from openmrs.temp_concept;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.cohort where cohort.uuid IN (select uuid from openmrs.temp_cohort);
insert into openmrs.cohort select * from openmrs.temp_cohort;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_description select * from openmrs.temp_concept_description;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.concept_map_type where concept_map_type.uuid IN (select uuid from openmrs.temp_concept_map_type);
insert into openmrs.concept_map_type select * from openmrs.temp_concept_map_type;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.concept_proposal where concept_proposal.uuid IN (select uuid from openmrs.temp_concept_proposal);
insert into openmrs.concept_proposal select * from openmrs.temp_concept_proposal;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_reference_map select * from openmrs.temp_concept_reference_map;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_reference_term select * from openmrs.temp_concept_reference_term;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.program_workflow_state select * from openmrs.temp_program_workflow_state;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.provider_attribute where provider_attribute.uuid IN (select uuid from openmrs.temp_provider_attribute);
insert into openmrs.provider_attribute select * from openmrs.temp_provider_attribute;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.provider_attribute_type select * from openmrs.temp_provider_attribute_type;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.relationship where relationship.uuid IN (select uuid from openmrs.temp_relationship);
insert into openmrs.relationship select * from openmrs.temp_relationship;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.visit_attribute_type select * from openmrs.temp_visit_attribute_type;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.visit_type where visit_type.uuid IN (select uuid from openmrs.temp_visit_type);
insert into openmrs.visit_type select * from openmrs.temp_visit_type;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.patient_identifier_type select * from openmrs.temp_patient_identifier_type;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.notification_template select * from openmrs.temp_notification_template;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.privilege where privilege.uuid IN (select uuid from openmrs.temp_privilege);
insert into openmrs.privilege select * from openmrs.temp_privilege;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from openmrs.role where role.uuid IN (select uuid from openmrs.temp_role);
insert into openmrs.role select * from openmrs.temp_role;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.cohort_member select * from openmrs.temp_cohort_member;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from concept_complex where (concept_complex.concept_id) IN (select concept_id from openmrs.temp_concept_complex);
insert into openmrs.concept_complex select * from openmrs.temp_concept_complex;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_name_tag_map select * from openmrs.temp_concept_name_tag_map;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from concept_numeric where (concept_numeric.concept_id) IN (select concept_id from openmrs.temp_concept_numeric);
insert into openmrs.concept_numeric select * from openmrs.temp_concept_numeric;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_proposal_tag_map select * from openmrs.temp_concept_proposal_tag_map;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_set_derived select * from openmrs.temp_concept_set_derived;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.concept_state_conversion select * from openmrs.temp_concept_state_conversion;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from concept_word where (concept_word.concept_word_id) IN (select concept_word_id from openmrs.temp_concept_word);
insert into openmrs.concept_word select * from openmrs.temp_concept_word;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.drug_ingredient select * from openmrs.temp_drug_ingredient;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from drug_order where (drug_order.order_id) IN (select order_id from openmrs.temp_drug_order);
insert into openmrs.drug_order select * from openmrs.temp_drug_order;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.location_tag_map select * from openmrs.temp_location_tag_map;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from patient where (patient.patient_id) IN (select patient_id from openmrs.temp_patient);
insert into openmrs.patient select * from openmrs.temp_patient;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.role_privilege select * from openmrs.temp_role_privilege;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.role_role select * from openmrs.temp_role_role;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.scheduler_task_config_property select * from openmrs.temp_scheduler_task_config_property;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from test_order where (test_order.order_id) IN (select order_id from openmrs.temp_test_order);
insert into openmrs.test_order select * from openmrs.temp_test_order;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;
...
insert into openmrs.user_property select * from openmrs.temp_user_property;
SET SQL_SAFE_UPDATES = 0;
set FOREIGN_KEY_CHECKS = 0;

delete from user_role where (user_role.user_id, user_role.role) IN (select user_id, role from openmrs.temp_user_role);
insert into openmrs.user_role select * from temp_user_role;
