 ...
 * 
 */
public class PatientSearchActivity extends Activity implements OnCheckedChangeListener, OnClickListener
{
					...
					protected void onPostExecute (Object result)
					{
						...
						try
						{
							...
							else
							{
								...
								{
									MyTextView textView = new MyTextView (PatientSearchActivity.this, R.style.text, R.string.empty_string);
						...
						catch (Exception e)
						{
							...
							App.getAlertDialog (PatientSearchActivity.this, AlertType.ERROR, getResources ().getString (R.string.parsing_error)).show ();
						}
					}
				};
				searchTask.execute ("");
			...
			else
			{
				...
				AsyncTask<String, String, Object> searchTask = new AsyncTask<String, String, Object> ()
				{
					protected Object doInBackground (String... params)
					{
						...
						try
						{
							patientData = serverService.searchPatients (id, first, last, gender, ageStart, ageEnd);
						}
							...
							for (String id : patientIdSet)
							{
								...
								textView.setOnClickListener (new OnClickListener ()
								{
									...
									public void onClick (View view)
									{
										...
										clipboard.setText (tv.getTag ().toString ());
										AlertDialog alertDialog = App.getAlertDialog (PatientSearchActivity.this, AlertType.INFO, getApplicationContext ().getString (R.string.text_copied));
										alertDialog.show ();
										finish ();
									}
								});
