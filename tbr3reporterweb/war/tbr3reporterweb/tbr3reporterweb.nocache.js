...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tbr3reporterweb" because\n';
  ...
  $wnd.__gwt_activeModules['tbr3reporterweb'] = {
    'moduleName' : 'tbr3reporterweb',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/tbr3reporterweb.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tbr3reporterweb'].superdevmode = true;

  var expectedSuffix = '/tbr3reporterweb.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tbr3reporterweb + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tbr3reporterweb';
  var devModeSessionKey = '__gwtDevModeSession:tbr3reporterweb';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tbr3reporterweb/tbr3reporterweb.nocache.js';
  ...
  $wnd.__gwt_activeModules['tbr3reporterweb'].canRedirect = true;
  $wnd.__gwt_activeModules['tbr3reporterweb'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING tbr3reporterweb';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tbr3reporterweb?user.agent=' + ua + '&_callback=' + callback;
