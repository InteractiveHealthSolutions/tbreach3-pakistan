...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "tbr3fieldmonitoring" because\n';
  ...
  $wnd.__gwt_activeModules['tbr3fieldmonitoring'] = {
    'moduleName' : 'tbr3fieldmonitoring',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/tbr3fieldmonitoring.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['tbr3fieldmonitoring'].superdevmode = true;

  var expectedSuffix = '/tbr3fieldmonitoring.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + tbr3fieldmonitoring + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:tbr3fieldmonitoring';
  var devModeSessionKey = '__gwtDevModeSession:tbr3fieldmonitoring';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/tbr3fieldmonitoring/tbr3fieldmonitoring.nocache.js';
  ...
  $wnd.__gwt_activeModules['tbr3fieldmonitoring'].canRedirect = true;
  $wnd.__gwt_activeModules['tbr3fieldmonitoring'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING tbr3fieldmonitoring';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/tbr3fieldmonitoring?user.agent=' + ua + '&_callback=' + callback;
