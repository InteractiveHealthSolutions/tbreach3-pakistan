...
public class PaediatricContactTracingActivity extends AbstractFragmentActivity
	...
	public void createViews(Context context) {
		...
		views = new View[] { age, ageModifier, contactTracingStrategy,
				screenedBefore, indexCaseId, indexDistrictTbNumber, diagnosis,
				weight, weightPercentile, cough, coughDuration, fever,
				nightSweats, weightLoss, contactAppetite, lymphNodeSwelling,
				jointSpineSwelling, chestExamination, lymphNodeExamination,
	...
	public boolean validate() {
		...
		View[] mandatory = { firstName, lastName, age, indexCaseId,
				otherExamination, exposureScore };
