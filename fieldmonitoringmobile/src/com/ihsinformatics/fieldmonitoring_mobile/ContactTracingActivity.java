...
public class ContactTracingActivity extends AbstractFragmentActivity implements
	...
	public void createViews(Context context) {
		...
		views = new View[] { contactTracingStrategy, indexCaseId,
				indexDistrictTbNumber, diagnosis, totalNumberAdultMembers,
				totalNumberAdultMembersWithSymptoms,
				totalNumberPaediatricMembers,
				totalNumberPaediatricMembersWithSymptoms,
	...
	public boolean validate() {
		...
		View[] mandatory = { indexCaseId, totalNumberAdultMembers,
				totalNumberPaediatricMembers };
		...
		if (valid) {
			...
			if (!RegexUtil.isNumeric(
					App.get(totalNumberPaediatricMembersWithSymptoms), false)) {
				valid = false;
