...
public class PediatricScreeningActivity extends AbstractFragmentActivity
	...
	public void createViews(Context context) {
		...
		views = new View[] { age, ageModifier, screenedBefore, cough,
				coughDuration, fever, nightSweats, weightLoss, childAppetite,
				positiveReport, lymphNodeSwelling, jointSpineSwelling,
				contactHistory, firstName, lastName, tbSuspect, patientId };
