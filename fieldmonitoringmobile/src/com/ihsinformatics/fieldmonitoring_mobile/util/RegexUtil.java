...
public class RegexUtil {
	...
	public static final String sentencePattern = "^[A-Za-z_ ,.0-9]+";
	...
	public static final String locationIdPattern = "[0-9]{6}";
	public static final String spirometryResultPattern = "[0-9]{2,2}\\.\\d[0-9]{1,2}";
	...
	public static boolean isSentence(String string) {
		try {
			return string.matches(sentencePattern);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
		}
	...
	public static boolean isLocationId(String string) {
		try {
			return string.matches(locationIdPattern);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
		}
	...
	public static boolean isSpirometryResultPattern(String string) {
		try {
			return string.matches(spirometryResultPattern);
		} catch (Exception e) {
			e.printStackTrace();
			return false;
		}
