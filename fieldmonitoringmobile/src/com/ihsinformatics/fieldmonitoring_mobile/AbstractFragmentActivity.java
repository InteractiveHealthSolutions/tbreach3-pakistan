...
public abstract class AbstractFragmentActivity extends FragmentActivity
	...
	public static final int VISIT_DATE_DIALOG_ID = 2;
	public static final int START_TIME_DIALOG_ID = 3;
	public static final int END_TIME_DIALOG_ID = 4;
	public static final int MR_LAST_VISIT_DATE_DIALOG_ID = 5;
	...
	protected Calendar visitDate;
	protected Calendar mrLastVisitDate;
	...
	protected Dialog onCreateDialog(int id) {
		...
		case VISIT_DATE_DIALOG_ID:
			OnDateSetListener visitDateSetListener = new OnDateSetListener() {
				@Override
				public void onDateSet(DatePicker view, int year,
						int monthOfYear, int dayOfMonth) {
					visitDate.set(year, monthOfYear, dayOfMonth);
					updateDisplay();
				}
			};
			return new DatePickerDialog(this, visitDateSetListener,
					visitDate.get(Calendar.YEAR),
					visitDate.get(Calendar.MONTH),
					visitDate.get(Calendar.DAY_OF_MONTH));

		case MR_LAST_VISIT_DATE_DIALOG_ID:
			OnDateSetListener mrLastVisitDateSetListener = new OnDateSetListener() {
				@Override
				public void onDateSet(DatePicker view, int year,
						int monthOfYear, int dayOfMonth) {
					mrLastVisitDate.set(year, monthOfYear, dayOfMonth);
					updateDisplay();
				}
			};
			return new DatePickerDialog(this, mrLastVisitDateSetListener,
					mrLastVisitDate.get(Calendar.YEAR),
					mrLastVisitDate.get(Calendar.MONTH),
					mrLastVisitDate.get(Calendar.DAY_OF_MONTH));
