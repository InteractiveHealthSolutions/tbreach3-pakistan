...
public class AdultScreeningActivity extends AbstractFragmentActivity implements
	...
	public void createViews(Context context) {
		...
		views = new View[] { age, screenedBefore, cough, coughDuration,
				coughProductive, tbBefore, tbMedication, tbInFamily,
				feverWeeks, nightSweats, weightLoss, positiveReport,
				lymphNodeSwelling, jointSpineSwelling, firstName, lastName,
				tbSuspect, patientId };
		for (View v : views) {
