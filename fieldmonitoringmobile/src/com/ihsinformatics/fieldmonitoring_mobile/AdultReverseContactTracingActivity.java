...
public class AdultReverseContactTracingActivity extends
		AbstractFragmentActivity implements OnEditorActionListener {
	...
	public void createViews(Context context) {
		...
		// R.string.index_district_number, R.string.index_district_number_hint,
		...
		View[][] viewGroups = {
				...
				{ tbBeforeTextView, tbBefore, tbMedicationTextView,
						tbMedication, tbSuspect, patientIdTextView, patientId,
						scanBarcode } };
		...
		views = new View[] { age, contactTracingStrategy, screenedBefore,
				indexCaseId, indexDistrictTbNumber, diagnosis, cough,
				coughDuration, productiveCough, fever, nightSweats, weightLoss,
				lymphNodeSwelling, jointSpineSwelling, tbBefore, tbMedication,
